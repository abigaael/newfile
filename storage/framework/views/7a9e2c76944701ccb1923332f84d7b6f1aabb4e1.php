            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form role="form" id="form-createmobil" action="<?php echo e(url('/mobil/create')); ?>" method="post" novalidate="novalidate">
          ...
          $("#form-createmobil").validate({
            rules: {
              kode_mobil: {
                  required: true,
                  remote : {
                              url: "<?php echo e(url('/uniquecarcode')); ?>",
                              type: "get",
                  },
              },
              car_name:"required",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.newapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\file\resources\views/mobil/listmobil.blade.php ENDPATH**/ ?>